      ...
      <Router>
        ...
        <div className="main flex-grow mx-3">
          <Routes>
            ...
            <Route
              path="/wordbook/:wordbook_id/edit"
              element={<EditWordbook />}
            />
            <Route
              path="/wordbook/:wordbook_id/view"
              element={<ViewWordbook />}
            />
            <Route
              path="/wordbook/:wordbook_id/learn"
              element={<LearnWordbook />}
            />
